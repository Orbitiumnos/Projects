...
/*
Используя схему БД автомобильного салона с таблицами Brand - марки автомобилей, 
Auto - доступные для покупки автомобили, составить запрос для поиска количества и общей стоимости автомобилей каждой марки 
(в определенный момент времени в салоне может не быть автомобилей конкретной марки)
*/
...
/*
Для приведенной в задаче 1 схеме данных составить запросы для определения:
1. марки автомобиля с самой высокой средней стоимостью автомобилей этой марки
2. количества немецких автомобилей
3. списка самых дорогих моделей автомобилей каждого бренда
*/
